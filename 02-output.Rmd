...
Be sure to pay attention to indentation and colon placement in your YAML header, especially as you start to specify options for particular output types. As a rule of thumb, if you have anything more than **output: output_type**, you need to indent every new line, and have a colon at the end of the previous line. See Section \@ref(usedef) for an example of this.
