...
I often work with colleagues who prefer to edit in Word, so sometimes I need to do this. 
I prefer not to if I can help it, because you lose several important functions; for example, chunk options for aligning and setting the size of graphs and other images don't work, and `kable` tables tend not to appear correctly.

## Rendering options

### Knit

You can specify a particular output type in the YAML header with the **output** option. 
