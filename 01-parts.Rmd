...
The YAML header goes at the very top of your document, and is where you set the global options for the output and formatting. 

This header is set apart from the rest of the document by three dashes/hyphens, as shown in the example below.
