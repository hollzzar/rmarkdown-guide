...
\includegraphics[width=\textwidth]{rmarkdown-guide_files/figure-latex/content_graph_1-1}
...
\NormalTok{dat }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Progress}\OperatorTok{==}\DecValTok{100} \OperatorTok{&}\StringTok{ }\NormalTok{ID }\OperatorTok{%notin%}\StringTok{ }\NormalTok{unusable)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=\textwidth]{rmarkdown-guide_files/figure-latex/content_graph_example-1}
...
\includegraphics[width=\textwidth]{rmarkdown-guide_files/figure-latex/content_graph_3-1}
...
\includegraphics[width=\textwidth]{rmarkdown-guide_files/figure-latex/content_graph_5-1}
...
\includegraphics[width=\textwidth]{rmarkdown-guide_files/figure-latex/content_graph_6-1}
